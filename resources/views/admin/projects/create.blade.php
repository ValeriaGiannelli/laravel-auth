...
<div class="container my-5">
    ...
    <form class="row g-3" action="{{route('admin.projects.store')}}" method="POST">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('project_type') is-invalid @enderror" id="project_type" name="project_type" placeholder="Inserisci la tipologia di progetto" value="{{old('project_type')}}">
