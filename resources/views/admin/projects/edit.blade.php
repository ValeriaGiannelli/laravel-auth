...
<div class="container my-5">
    ...
    <form class="row g-3" action="{{route('admin.projects.update', $project)}}" method="POST">
        ...
        <div class="col-md-6">
            <label for="project_type" class="form-label">Tipo di progetto(*)</label>
            <input type="text" class="form-control @error('project_type') is-invalid @enderror" id="project_type" name="project_type" placeholder="Inserisci la tipologia di progetto" value="{{old('project_type', $project->project_type)}}">
